    ...
    if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadFile)) {
        ...
        try {
            ...
            foreach ($rows as $index => $row) {
                ...
                // 데이터베이스에 데이터 삽입
				////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				$sql = "INSERT INTO wms_cate (cate_name, cate_rdate) VALUES (:name, :date)";
            ...
            // 업로드 결과 팝업 띄우기
            //echo "<script> var resultFileName = '" . urlencode($resultFileName) . "'; var popupUrl = '/excel/upload_result_popup_s01_user.php?file=' + resultFileName; window.open(popupUrl, 'ResultPopup', 'width=600,height=400'); </script>";
