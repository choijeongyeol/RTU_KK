...
<style>body{ background:#fff}</style>
	...
	<script>
		function sendit(){
			...
			location.href='/gm/home/dashboard.php?out_graph='+out_selectV+'&graph='+selectV;
		}	
	</script>
              ...
              <div class="col-md-12 col-sm-12 "> 
                <div class="x_panel">
                  <div class="x_title" style="display:flex">
                    ...
                    <div class="clearfix" style="width:30%;text-align:right"><a href="/gm/m07/list.php?h_loc_code=m06&h_location=입출고관리">more▷</a></div>
                  </div>
                  <div class="x_content">
                     <div class="row">
						<div class="col-sm-12">
