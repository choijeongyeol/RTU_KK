	...
	<!-- 게시판 리스트 계산 start -->
	<?
	$list_condition = "wms_items as i, wms_cate as c where i.item_cate = c.cate_id and i.delYN = 'N' and i.partner_id =".$_SESSION['partner_id']." and  c.partner_id =".$_SESSION['partner_id'];
              ...
              <div class="col-md-12 col-sm-12 "> 
                <div class="x_panel">
                  <div class="x_title" style="display:flex">
                    ...
                    <div class="clearfix" style="width:30%;text-align:right"><a href="/gm/m03/list.php">more▷</a></div>
                  </div>
                  <div class="x_content">
                     <div class="row">
						<div class="col-sm-12">
