        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/gm/home/dashboard.php" class="site_title"><!-- <i class="fa fa-paw"></i> --> <span>WMS Administrator</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="/gm/images/user.png" alt="..." class="img-circle profile_img">
              </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/gm/home/dashboard.php">메인화면</a></li>
                      <li><a href="/gm/home/myinfo.php">개인정보수정</a></li>
				...
				?>					  
                  <li><a><i class="fa fa-edit"></i> 창고관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/gm/m02/list.php">창고목록</a></li>
                    </ul>
                  </li>
				<?
				}
				...
				?>				  
                  <li><a><i class="fa fa-desktop"></i>제품관리<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/gm/m03/list.php">제품목록</a></li>
                     <!-- <li><a href="/gm/m03/list_history.php">제품입고 history</a></li> -->
                      <li><a href="/gm/m03/cate_list.php">제품분류 관리</a></li>
                   </ul>
                  </li>
				<?
				}
				...
				?>					  
                  <li><a><i class="fa fa-table"></i> 재고관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/gm/m04/list.php">재고목록</a></li>
                       <!-- <li><a href="/gm/m04/list_not_warehouse.php">재고목록(창고밖)</a></li>	 -->				  
                      <!-- <li><a href="/gm/m04/list_history.php?left_location=2">제품이동 history</a></li> -->
                    </ul>
                  </li>
				<?
				}
				...
				?>					  
                  <li><a><i class="fa fa-bar-chart-o"></i> 입고지시관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/gm/m05/list.php">입고지시</a></li>
                    </ul>
                  </li>		
				<?
				}
				...
				?>					  
                  <li><a><i class="fa fa-clone"></i>출고지시관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/gm/m06/list.php">출고지시</a></li>
                    </ul>
                  </li>
				<?
				}
				...
				?>					  
                  <li><a><i class="fa fa-clone"></i>HISTORY 관리<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <!-- <li><a href="/gm/m07/list.php">HISTORY 조회</a></li> -->
					<?
					...
					?>	
	                      <li><a href="/gm/m07/list.php?h_loc_code=<?echo "{$location_list['h_loc_code']}"?>&h_location=<?echo "{$location_list['h_location']}";?>"><?echo "{$location_list['h_location']}";?></a></li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i>운영자 관리<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li style="<?echo $permission_R_menu01_list_button?>"><a href="/gm/s01/list.php">운영자 목록</a></li>
                      <li style="<?echo $permission_R_menu01_list_button?>"><a href="/gm/s01/user_list.php">사용자 목록</a></li>
                      <li style="<?echo $permission_R_menu01_menu01_cate_list_button?>"><a href="/gm/s01/cate_list.php">분류명 관리</a></li>
                      <li><a href="/gm/s01/company_list.php">입출고 거래처명관리</a></li>					  
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> 접근권한관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li style="<?echo $permission_R_menu04_list_button?>"><a href="/gm/s02/list.php?left_location=1">권한관리목록</a></li>
                    </ul>
                  </li>				  
                  <li><a><i class="fa fa-windows"></i>시스템 관리<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/gm/s03/list.php">시스템설정</a></li>
