...
function popup_win_size_angle(arg1,arg2,w,h) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m02/ctrl_'+arg1+'_input.php?arg2='+arg2,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
...
function popup_win_in(arg1,arg2,arg3,arg4) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m03/ctrl_'+arg1+'_input.php?arg2='+arg2+'&arg3='+arg3+'&arg4='+arg4, '', 'status=no, height=300, width=500, left='+ popupX + ', top='+ popupY);
	//var childWindow = window.open('ctrl_'+arg1+'_input.php?arg2='+arg2+'&arg3='+arg3+'&arg4='+arg4, '자식 창', 'width=400,height=300');
...
function popup_win_inreg(arg1,arg2) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m03/ctrl_'+arg1+'_input.php?arg2='+arg2, '', 'status=no, height=500, width=500, left='+ popupX + ', top='+ popupY);
	//var childWindow = window.open('ctrl_'+arg1+'_input.php?arg2='+arg2+'&arg3='+arg3+'&arg4='+arg4, '자식 창', 'width=400,height=300');
...
function order_up_angle(arg1,arg2,arg3) {
    ...
    var url = '/gm/inc/iframe_angle_up.php?warehouse_id='+arg1+'&angle_id='+arg2+'&angle_order='+arg3;
    iframe.src = url;
	location.href="/gm/m02/list.php";
}
...
function order_down_angle(arg1,arg2,arg3) {
    ...
    var iframe = document.getElementById('myIframe');
    var url = '/gm/inc/iframe_angle_down.php?warehouse_id='+arg1+'&angle_id='+arg2+'&angle_order='+arg3;
    iframe.src = url;
	location.href="/gm/m02/list.php";
}
...
function popup_win_angle_update(arg1,arg2,arg3,w,h) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m02/ctrl_'+arg1+'_input.php?arg1='+arg1+'&arg2='+arg2+'&arg3='+arg3,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
}
...
function popup_win_partner_reg(arg,w,h) {
...
function fn_user_cate(arg1,arg2,arg3){  //   W,1,  {$user['access_id']}//{$user['access_name']}//W//{$cate['cate_admin_role']}
    ...
    var url = '/gm/inc/iframe.php?mode='+arg1+'&num='+arg2+'&m04_access_id='+arr_str[0]+'&m04_access_name='+arr_str[1]+'&m04_access_type='+arr_str[2]+'&m04_access_value='+arr_str[3];
 
     var iframe = document.getElementById('myIframe');	
     iframe.src = url;
     location.href="/gm/s02/list.php";	
}
...
function fn_cate_change(arg1,arg2){
	...
	if (arg1=="x")
	{
		...
		url = '/gm/inc/iframe.php?cate_change=Y&item_cate='+arg1+'&item_id='+arg2;	
	}
     var iframe = document.getElementById('myIframe');	
     iframe.src = url;
	 alert("변경되었습니다.");
	 top.location.reload();
     //location.href="/gm/m03/list.php";		
}
...
function fn_user_cate_del(arg1,arg2,arg3){  //   1,W,99
     ...
     var url = '/gm/inc/iframe.php?access_id='+arg1+'&access_type='+arg2+'&role='+arg3;
...
function popup_win_inbound_update(arg1,arg2,w,h,plandate) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m05/ctrl_'+arg1+'_input.php?arg1='+arg1+'&arg2='+arg2+'&plandate='+plandate,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
}
...
function popup_win_outbound_update(arg1,arg2,w,h) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m06/ctrl_'+arg1+'_input.php?arg1='+arg1+'&arg2='+arg2,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
}
...
function popup_win_inbound_del(arg1,arg2,w,h) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m05/ctrl_'+arg1+'_input.php?arg1='+arg1+'&arg2='+arg2,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
}
...
function popup_win_warehouse_update(arg1,arg2,w,h) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m02/ctrl_'+arg1+'_input.php?arg1='+arg1+'&arg2='+arg2,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
}
...
function popup_win_product_del(arg1,arg2,w,h) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('../m03/ctrl_'+arg1+'_input.php?arg1='+arg1+'&arg2='+arg2,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
}
...
function popup_win_item_update(arg1,arg2,w,h) {
	...
	// 자식 창을 열고 창 객체를 저장
	var childWindow = window.open('/gm/m03/ctrl_'+arg1+'_input.php?arg1='+arg1+'&arg2='+arg2,  '', 'status=no, height='+h+', width='+w+', left='+ popupX + ', top='+ popupY);
}
