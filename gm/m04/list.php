...
<?$queryString = $_SERVER['QUERY_STRING'];?>	
    ...
    <?  /// 권한 체크 : 조회권한 ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('재고조회 권한이 없습니다.');location.href='/gm/home/dashboard.php'</script>"; exit();	 }
   ...
   if (($_GET['searchStartDate']!="") && ($_GET['searchEndDate']!="")) {  // r날짜 조건검색 
	...
	$list_condition = " wms_stock AS s LEFT JOIN  wms_items AS i  ON s.item_id = i.item_id LEFT JOIN  wms_warehouses AS w  ON s.warehouse_id = w.warehouse_id  JOIN  wms_angle AS a  ON s.angle_id = a.angle_id and i.partner_id = s.partner_id WHERE 1=1 and s.partner_id =  ".$_SESSION['partner_id']." and  w.delYN = 'N' AND a.delYN = 'N' ".$add_sql.$search_add;
