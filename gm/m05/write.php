...
$(document).ready(function(){
	...
	$('#save_button').click(function(){
		...
		$.post("../inc/fn.php", formData, function(response){		
			...
			alert(cleanedString); location.href="/gm/m05/list.php";
			// 추가 작업 수행 (예: 페이지 새로고침)
		});
	});
});
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
				...
				<tr>
					...
					<td>					<a href="/gm/m05/list.php"><button type='button' class='btn btn-secondary btn-sm'  style='<?echo $permission_W_button?>margin-top:120px;padding:12;width:90%;height:50px;font-weight:bold' value="대상 등록">목록</button></a>	
					</td>
				</tr>
				</table>
				</div>
