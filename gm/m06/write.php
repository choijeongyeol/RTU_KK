...
.myClass_lable.ess:after {content:""; color:#ff0000; margin-left:5px; width:10px; height:10px; background:transparent url('/gm/images/ess.svg') left center no-repeat; display:inline-block;}
...
.buttonClass{ width:220px;height:30px;text-align:center;border: 1px solid #EBEBF2;color:#fff;background:#ff0000;margin-top:5px}
 ...
 <script>
	function reload(){
		location.href="/gm/m06/write.php";
	}
 </script>
        ...
        $(document).ready(function() {
            ...
            $("#save_button").click(function() {
				...
				alert(cleanedString);  // 응답 메시지 출력
					location.href = "/gm/m06/list.php"; // 목록 페이지로 이동
				});
            });
        });
    </script> 
 ...
 <!-- 
				...
				<tr>
					...
					<td>					<a href="/gm/m06/list.php"><button type='button' class='btn btn-secondary btn-sm'  style='<?echo $permission_W_button?>margin-top:120px;padding:12;width:90%;height:50px;font-weight:bold' value="대상 등록">목록</button></a>	
					</td>
				</tr>
				</table>
				</div>
