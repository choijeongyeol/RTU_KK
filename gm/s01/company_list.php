...
<? include_once($_SERVER['DOCUMENT_ROOT'].'/gm/inc/topmenu.php'); ?>
    ...
    <?  /// 권한 체크 : 조회권한 ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('운영자분류명관리 조회 권한이 없습니다.');location.href='/gm/home/dashboard.php'</script>"; exit();	 }
	...
	<!-- 게시판 리스트 계산 start -->
	<?
	$list_condition = "wms_company where delYN = 'N' and partner_id = ".$_SESSION['partner_id']." and cate_id <> 0 ";
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>운영자관리 > 출고 업체명관리<small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                     <div class="row">
				...
				<?php
				// 분류 목록 가져오기
				$cates = getwms_company($start_record_number,$itemsPerPage);
				?>				
					...
					<?
						...
						if ($cates) {
							...
							foreach ($cates as $cate) {
								...
								echo "<td><".$permission_U_button."a onclick=popup_win3('company_edit','{$cate['cate_id']}') style='cursor:pointer'>{$cate['cate_name']}</a>";
								echo "</td>";
							...
							echo "<tr><td colspan='4'>등록된 정보 없음</td></tr>";
						}
					?>		
					</tbody>
				</table>
				...
				<div style="width:98%;text-align:right">
					<button type='button' class='btn btn-secondary btn-sm'  onclick="popup_win('company')" style='<?echo $permission_W_button?>margin-top:120px;padding:12;width:100%;height:50px;font-weight:bold' value="분류 등록">업체명 등록</button>	
				</div>
