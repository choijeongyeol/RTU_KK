...
<br>				
	<center><h2><span style="font-size:18px;font-weight:bold;color:#fff">분류명칭 수정</span></h2></center>
	...
	<form name="popup_form"  method="post" action="<?echo $_SERVER['PHP_SELF']?>">
		...
		<div class="item form-group" >
			...
			<div class="col-md-6 col-sm-6 " style="margin-bottom:10px">
				<input type="number" required="required" class="form-control " name="cate_admin_role" value="<?echo $cate_admin_role?>" readonly>
