<? include_once($_SERVER['DOCUMENT_ROOT'].'/gm/inc/head.php'); ?>
 ...
 <body style="overflow: hidden;background:#405469">
  ...
  <?
	if((isset($_POST['user_id'])&&($_POST['user_id']!=""))&&(isset($_POST['user_pw'])&&($_POST['user_pw']!=""))){	
		
	    user_change_pw($_POST['user_id'],$_POST['user_pw']); 
	...
	<input type="hidden" name="user_id"  value="<? echo $_GET['arg2']?>">
		...
		<div class="item form-group" >
			...
			<div class="col-md-6 col-sm-6 " style="margin-bottom:10px">
                ...
                <input type="text" required="required" class="form-control " name="user_pw"  >
			</div> 	
		</div>
