...
<? include_once($_SERVER['DOCUMENT_ROOT'].'/gm/inc/topmenu.php'); ?>
    ...
    <?  /// 권한 체크 : 조회권한 ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('시스템설정 조회 권한이 없습니다.');location.href='/gm/home/dashboard.php'</script>"; exit();	 }
	...
	<!-- 게시판 리스트 계산 start -->
	<?
	$list_condition = "wms_setting where partner_id =".$_SESSION['partner_id'];
						...
						if ($sys_status) {
							...
							?>
									  <td> 
										...
										<button type="button" class='btn btn-secondary btn-sm' style='<?echo $permission_U_button?>'  onClick=Status(document.reservation,'<? echo "{$status['id']}"; ?>','<?echo $i?>')>수정 </button>
