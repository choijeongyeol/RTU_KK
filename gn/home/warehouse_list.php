    <? 
 	...
 	$list_condition = "wms_warehouses where 1=1 and warehouse_id <> 0 and delYN = 'N' ";
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title" style="display:flex">
                    ...
                    <div class="clearfix" style="width:30%;text-align:right"><a href="/gn/m02/list.php">more▷</a></div>
                  </div>
                  <div class="x_content">
                     <div class="row">
						<div class="col-sm-12">
					...
					<?  
						...
						if ($warehouses) {
							...
							foreach ($warehouses as $warehouse) {
								...
								echo "</td>";
								echo "<td><button type='button' class='btn btn-secondary btn-sm' style='".$permission_W_button."padding:2;width:70px' value='앵글삽입'  onclick=popup_win_size_angle('angle',{$warehouse['warehouse_id']},400,400) style='".$permission_W_button."cursor:pointer'>삽입</button>".$permission_W_txt."</td>";
