...
<? include_once($_SERVER['DOCUMENT_ROOT'].'/gn/inc/topmenu.php'); ?>
    ...
    <?  /// 권한 체크 : 조회권한 - 메인화면 리다이렉트 ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if ($pm_rst_R2 == 'F') {	 echo "<script>alert('창고조회 권한이 없습니다.');location.href='/gn/home/dashboard.php'</script>"; exit();	 }
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('앵글조회 권한이 없습니다.');location.href='/gn/home/dashboard.php'</script>"; exit();	 }
              ...
              <div class="col-md-12 col-sm-12 ">
				...
				<div style="width:98%;text-align:right;background-color:#cfe9da;<? echo $permission_W2_button;?>">
					<form action="/excel/upload_<?echo $this_f_name;?>.php" method="post" enctype="multipart/form-data" target="upload_iframe" onsubmit="showPopup();">
						<label for="file"><u><a href="/excel/sample_excel/sample_<?echo $this_f_name;?>.xlsx">엑셀샘플 다운로드</a></u> &nbsp;| &nbsp;엑셀 파일 선택:</label>
