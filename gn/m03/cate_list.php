...
<? include_once($_SERVER['DOCUMENT_ROOT'].'/gn/inc/topmenu.php'); ?>
    ...
    <?  /// 권한 체크 : 조회권한 ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('제품카테고리 조회 권한이 없습니다.');location.href='/gn/home/dashboard.php'</script>"; exit();	 }
	...
	<!-- 게시판 리스트 계산 start -->
	<?
	$list_condition = "wms_cate where delYN = 'N' and cate_id <> 0 ";
              ...
              <div class="col-md-12 col-sm-12 ">
				...
				<div style="width:98%;text-align:right;background-color:#cfe9da;<? echo $permission_W_button;?>">
					<form action="/excel/upload_<?echo $this_f_name;?>.php" method="post" enctype="multipart/form-data" target="upload_iframe" onsubmit="showPopup();">
						<label for="file"><u><a href="/excel/sample_excel/sample_<?echo $this_f_name;?>.xlsx">분류샘플 다운로드</a></u> &nbsp;| &nbsp;엑셀 파일 선택:</label>
