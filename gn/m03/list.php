...
<?$queryString = $_SERVER['QUERY_STRING'];?>
    ...
    <?  /// 권한 체크 : 조회권한 ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('제품조회 권한이 없습니다.');location.href='/gn/home/dashboard.php'</script>"; exit();	 }
   ...
   if (($_GET['searchStartDate']!="") && ($_GET['searchEndDate']!="")) {  // r날짜 조건검색 
	...
	$list_condition = "wms_items as i, wms_cate as c where i.item_cate = c.cate_id and i.delYN = 'N' ".$add_condition;
			...
			<input type="text" name="SearchString2" >
                        ...
                        <ul>
                            ...
                            <li>
                                <span class="c_btn h34 blue">
                                    ...
                                    <input type="button" style="margin-left:-10px;margin-right:-7px;" onclick="location.href='/excel/phpspread_m03.php?<?echo $queryString;?>'" value="엑셀받기" />	
                                </span>
                            </li>
				...
				<div style="width:98%;text-align:right;background-color:#cfe9da;<? echo $permission_W_button;?>">
					<form action="/excel/upload_<?echo $this_f_name;?>.php" method="post" enctype="multipart/form-data" target="upload_iframe" onsubmit="showPopup();" >
						...
						<br><label for="file" style="padding:12;margin-right:0px;margin-bottom:0px" ><u><a href="/excel/sample_excel/sample_<?echo $this_f_name;?>.xlsx">제품샘플 다운로드</a></u>&nbsp;|&nbsp;엑셀 파일 선택:<input type="file" name="file" id="file" required></label>
