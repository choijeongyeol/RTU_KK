...
if(isset($_POST['item_name']) && ($_POST['item_name']!="")){  		
     del_inbound($_POST['inbound_id']); // 주석처리된 함수 호출을 해제하여 사용할 수 있습니다.
...
<br />
<center><h2><span style="font-size:18px; font-weight:bold; color:#fff">입고지시 삭제</span></h2></center>
...
<?php
$result = getwms_wms_inbound_info($_GET['arg2']);
if (!empty($result)) {
...
<form name="popup_form" id="popup_form" method="post" action="<?php echo $_SERVER['PHP_SELF']?>">
    <input type="hidden" name="inbound_id" value="<?php echo $_GET['arg2'] ?>" >
