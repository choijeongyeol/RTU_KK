...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO wms_inbound (product_id, company_id, warehouse_id, angle_id, planned_quantity, inbound_quantity,plan_date,rdate) VALUES (:product_id, :company_id, :warehouse_id,:angle_id, :planned_quantity, :inbound_quantity, :plan_date, :rdate)");
