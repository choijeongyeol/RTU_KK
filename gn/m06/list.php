                        ...
                        <ul>
                            ...
                            <li>
                                <span class="c_btn h34 blue">
                                    ...
                                    <input type="button" style="margin-left:-10px;margin-right:-7px;" onclick="location.href='/excel/phpspread_m06.php?<?echo $queryString;?>'" value="엑셀받기" />	
									...
									<table width="100%">
									<tr>
										<td colspan="3" style="text-align:right;width:100%;<?echo $permission_W_button;?>"> <a href="/gn/m06/write.php"><button type='button' class='btn btn-secondary btn-sm' style='padding:2;width:127px;background:#ff0000'  >지시생성</button></a></td>
									</tr>
