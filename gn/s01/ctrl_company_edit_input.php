<? include_once($_SERVER['DOCUMENT_ROOT'].'/gn/inc/head.php'); ?>
 ...
 <?  
	if(isset($_POST['cate_name'])&&($_POST['cate_name']!="")&&isset($_POST['cate_id'])&&($_POST['cate_id']!="")){	
		...
		if ($cate_cnt[0]['cate_cnt'] == 0) {
			updatecompany($_POST['cate_name'],$_POST['cate_id']);
 ...
 ?>
				...
				//echo $_GET['arg2'];
				// 제품 가져오기
				$cates_1 = getwms_company_search1($_GET['arg2']);				
						if ($cates_1) {
							$i=1;
...
<br>				
	<center><h2><span style="font-size:18px;font-weight:bold;color:#fff">입출고 업체명 정보수정</span></h2></center>
