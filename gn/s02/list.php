...
<?
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('권한관리목록 조회 권한이 없습니다.');location.href='/gn/home/dashboard.php'</script>"; exit();	 }
					...
					<?
						...
						if ($users) {
							...
							foreach ($users as $user) {
								...
								if ($i!=1) { echo "<a href='/gn/s02/list.php?left_location=1&up_sorting={$user['access_order']}'>△</a>"; }
