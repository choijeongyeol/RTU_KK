    <?  /// 권한 체크 : 조회권한 ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if ($pm_rst_R == 'F') {	 echo "<script>alert('HISTORY조회 권한이 없습니다.');location.href='/gu/home/dashboard.php'</script>"; exit();	 }
	...
	$list_condition = "RTU_history where 1=1  and  partner_id =".$_SESSION['partner_id'].$add_condition;
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title" style="display:flex">
					...
					<small></small></h2></div>
                    <div class="clearfix" style="width:30%;text-align:right"><a href="/gu/m07/list.php?h_loc_code=<?echo $h_loc_code;?>&h_location=<?echo $h_location;?>">more▷</a></div>
                  </div>
                  <div class="x_content">
                     <div class="row">
						<div class="col-sm-12">
