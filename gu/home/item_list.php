	...
	<!-- 게시판 리스트 계산 start -->
	<?
	$list_condition = "RTU_items as i, RTU_cate as c where i.item_cate = c.cate_id and i.delYN = 'N' and i.partner_id =".$_SESSION['partner_id']." and  c.partner_id =".$_SESSION['partner_id'];
              ...
              <div class="col-md-12 col-sm-12 "> 
                <div class="x_panel">
                  <div class="x_title" style="display:flex">
                    ...
                    <div class="clearfix" style="width:30%;text-align:right"><a href="/gu/m03/list.php">more▷</a></div>
                  </div>
                  <div class="x_content">
                     <div class="row">
						<div class="col-sm-12">
				...
				<?php
				// 제품 목록 가져오기
				$items = getRTU_items($start_record_number,8,$search,$SearchString);
				?>				
					...
					<?
						...
						if ($items) {
							...
							foreach ($items as $item) {
								...
								$cates = getRTU_cate($start_record_number,$itemsPerPage);
								if ($cates) { ?>
