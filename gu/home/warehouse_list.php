    <? 
 	...
 	$list_condition = "RTU_warehouses where 1=1 and  partner_id =".$_SESSION['partner_id']." and warehouse_id <> 0 and delYN = 'N' ";
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title" style="display:flex">
                    ...
                    <div class="clearfix" style="width:30%;text-align:right"><a href="/gu/m02/list.php">more▷</a></div>
                  </div>
                  <div class="x_content">
                     <div class="row">
						<div class="col-sm-12">
				...
				<?php
				// 창고 목록 가져오기
				$warehouses = getRTU_warehouses(0,2,$search,$SearchString);
				?>				
					...
					<?  
						...
						if ($warehouses) {
							...
							foreach ($warehouses as $warehouse) {
								...
								$angle_lists = getRTU_angle_namelist("{$warehouse['warehouse_id']}");
