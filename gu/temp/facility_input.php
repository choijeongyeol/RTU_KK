...
/////////////////// spartner_id 구하기 /////////////////////////////////////////////////////////////	
	function getSpartnerIdByUserId(PDO $conn, string $user_id): ?int {
		try {
			// spartner_id 조회 쿼리
			$sql = "SELECT spartner_id FROM RTU_user WHERE user_id = :user_id AND delYN = 'N' LIMIT 1";
			...
			return $result ? (int)$result['spartner_id'] : null;
		} catch (PDOException $e) {
			// 오류 처리 (로그 기록 또는 예외 전달)
			error_log("Error fetching spartner_id: " . $e->getMessage());
			return null;
		}
	}	
			
		$spartner_id = getSpartnerIdByUserId($conn, $user_id);

		if ($spartner_id !== null) {
			//echo "User ID: $user_id 의 spartner_id: $spartner_id";
		} else {
			//echo "User ID: $user_id 에 대한 spartner_id를 찾을 수 없습니다.";
		}		
/////////////////// spartner_id 구하기 /////////////////////////////////////////////////////////////	
    ...
    try {
        ...
        $rtu_code = $lora_result['rtu_code'];  //kk_3
