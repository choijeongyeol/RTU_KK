...
<body>
    ...
    <ul>
        ...
        <li><a href="partner_list.php" target="mainFrame">관리자관리</a></li>
        <li>---------------</li>
		<? } ?>
        <li><a href="spartner_list.php" target="mainFrame">지자체관리</a></li>
        <li>---------------</li>
        <li><a href="user_list.php" target="mainFrame">이용자 관리</a></li>
        <!-- <li><a href="user_form.php" target="mainFrame">이용자 등록</a></li> -->
        <li><a href="lora_form.php" target="mainFrame">로라 등록</a></li>
        <li><a href="facility_form.php" target="mainFrame">설비관리</a></li>	
        <!-- <li><a href="facility_subscription.php" target="mainFrame">설비연결관리</a></li>	 -->
        <li>---------------</li>
		<li><a href="/gu/view/list_sunlight_0101.php" target="mainFrame">태양광 단상목록</a></li>
		<li><a href="/gu/view/list_sunlight_0103.php" target="mainFrame">태양광 삼상목록</a></li>
        ...
        <li>---------------</li>
        <li><a href="technician_list.php" target="mainFrame">장애처리담당자관리</a></li>
        <li>---------------</li>
        ...
        <li>---------------</li> 
        <li><a href="weather_js.php" target="mainFrame">기상정보</a></li>
