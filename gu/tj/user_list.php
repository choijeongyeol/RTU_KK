...
<a href="download_sample.php" target="_blank">        <button type="button">샘플 엑셀 파일 다운로드</button>    </a> / 	


<form action="user_upload_process.php" method="POST" enctype="multipart/form-data">
    <label for="excel_file">엑셀 파일 업로드:</label>
    <input type="file" name="excel_file" accept=".xlsx, .xls, .csv" required>
    <button type="submit">업로드 및 사용자 등록</button>
</form>
