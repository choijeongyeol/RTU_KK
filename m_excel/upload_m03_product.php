...
$this_f_name = "m03_product_".$partner_id; // 분류
    ...
    if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadFile)) {
        ...
        try {
            ...
            foreach ($rows as $index => $row) {
				...
				$item_cate_num = cate_name_to_cate_id_use($item_cate_name);  
				
				
                // 분류가 없으면 wms_cate 테이블에 추가
                if ($item_cate_num === null) {
                    $item_cate_num = add_category($partner_id, $item_cate_name, $date);
                }				

				// 데이터베이스에 데이터 삽입
				////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				$sql = "INSERT INTO wms_items (partner_id, item_code, item_name, item_rdate, item_cate) VALUES (:partner_id, :code, :name, :date, :item_cate)";			
